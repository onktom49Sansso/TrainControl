...
def main():
    ...
    GPIO.setup(21, GPIO.OUT)							# WeichenSchaltStrom
    ...
    GPIO.output(21, GPIO.HIGH)											# Hauptschalter fuer Weichen aus
    ...
    def Zugauswahl(x):
        ...
        if Gleis[0] == "1":
            ...
            GPIO.output(16, GPIO.LOW)  # Weiche 1 aussen
            GPIO.output(20, GPIO.LOW)  # Weiche 3 aussen
            print ("A   Weichen_schalten")
            Weichen_schalten()
            GPIO.output(33, GPIO.HIGH)  # Stopp 1 aus, Fahrt
            time.sleep(15)
            EsFaehrt == 1

        else:
            print ("A   Schaltung Gleis 3")
            GPIO.output(16, GPIO.HIGH)  # Weiche 1 innen
            GPIO.output(20, GPIO.HIGH)  # Weiche 3 innen
            print ("A   Weichen_schalten")
            Weichen_schalten()
            GPIO.output(33, GPIO.HIGH)  # Stopp 3 aus, Fahrt
            EsFaehrt == 3
